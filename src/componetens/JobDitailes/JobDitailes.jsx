...
import { saveJobApplication } from "../../Utility/loaclStorge";
    ...
    <div>
      <div className="grid gap-4 md:grid-cols-4 mt-10">
        ...
        <div className="border bg-[#c4caf5] p-5 rounded-lg">
          ...
          <button  onClick={hadleJobApplication} className="w-full mt-5 btn btn-primary">Apply Now</button>
        </div>
